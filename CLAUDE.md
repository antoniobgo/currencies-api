...
- Sempre responda pensando nas melhores práticas do mercado (quando aplicável), tanto para testes, arquitetura, padrões de projeto e código de qualidade como um desenvolvedor sênior ou melhor.
